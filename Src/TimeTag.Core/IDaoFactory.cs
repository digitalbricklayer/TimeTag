...
namespace Openxtra.TimeTag.Database
{
    internal interface IDaoFactory
    {
        ...
        IDataSourceDao CreateDataSource(ITimeSeriesDatabaseDao databaseDao);
        IArchiveTemplateDao CreateArchiveTemplate(ITimeSeriesDatabaseDao databaseDao);
        IArchiveDao CreateArchive(IDataSourceDao dataSourceDao);
        IReadingDao CreateReading(IArchiveDao archiveDao);
        IDataPointDao CreateDataPoint(IArchiveDao archiveDao);
    }
}
