...
namespace Openxtra.TimeTag.Database
{
    ...
    internal interface ITimeSeriesDatabaseDao
    {
        void Connect(TimeSeriesDatabase.ConnectionMode mode);
        void Close();
        bool IsConnected();
        void Create(TimeSeriesDatabaseDto dto);
        TimeSeriesDatabaseDto Read();
        void Lock();
        void Unlock();
